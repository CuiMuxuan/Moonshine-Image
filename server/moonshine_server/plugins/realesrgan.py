...
from moonshine_server.helper import download_model
from moonshine_server.plugins.base_plugin import BasePlugin
from moonshine_server.schema import RunPluginRequest, RealESRGANModel
...
class RealESRGANer:
    ...
    def __init__(
        ...
        if isinstance(model_path, list):
            ...
            loadnet = load_torch_checkpoint(model_path, map_location=torch.device("cpu"))
    ...
    def dni(self, net_a, net_b, dni_weight, key="params", loc="cpu"):
        ...
        """
        net_a = load_torch_checkpoint(net_a, map_location=torch.device(loc))
        net_b = load_torch_checkpoint(net_b, map_location=torch.device(loc))
