...
from moonshine_server.schema import Device, RunPluginRequest, RemoveBGModel
...
class RemoveBG(BasePlugin):
    ...
    def _init_session(self, model_name: str):
        ...
        if model_name == RemoveBGModel.briaai_rmbg_1_4:
            from moonshine_server.plugins.briarmbg import (
            ...
            from moonshine_server.plugins.briarmbg2 import (
