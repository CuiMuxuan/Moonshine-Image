        ...
        if model_md5:
            ...
            if model_md5 == _md5:
                ...
                try:
                    ...
                    logger.error(
                        f"Model md5: {_md5}, expected md5: {model_md5}, wrong model deleted. Please restart moonshine_server."
                        f"If you still have errors, please try download model manually first https://lama-cleaner-docs.vercel.app/install/download_model_manually.\n"
                    )
                except:
                    logger.error(
                        f"Model md5: {_md5}, expected md5: {model_md5}, please delete {cached_file} and restart moonshine_server."
                    )
                exit(-1)
...
def handle_error(model_path, model_md5, e):
    ...
    if _md5 != model_md5:
        try:
            ...
            logger.error(
                f"Model md5: {_md5}, expected md5: {model_md5}, please delete {model_path} and restart moonshine_server."
            )
    else:
        logger.error(
