...
const runtimeFlavor = String(process.env.MOONSHINE_RUNTIME_FLAVOR || "cu126").trim().toLowerCase();
const runtimeEnvName =
  process.env.MOONSHINE_RUNTIME_ENV_NAME || `moonshine-runtime-312-${runtimeFlavor}`;
