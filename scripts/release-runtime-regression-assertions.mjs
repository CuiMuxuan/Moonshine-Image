...
const checks = [
  ...
  ["scripts/audit-release-runtime.mjs", "builder-gpu-architecture-incompatible"],
  ["scripts/audit-release-runtime.mjs", "cudaerrornokernelimagefordevice"],
  ...
  ["scripts/run-sam3-compatibility-regression.mjs", '|| "cu130"'],
  ["scripts/run-sam3-compatibility-regression.mjs", "MOONSHINE_CU130_RUNTIME_ENV_NAME"],
  ["scripts/package-win-matrix.mjs", "auditPackagedRuntimeDirectory"],
  ["scripts/package-win-matrix.mjs", "verification: artifact.audit"],
  ["scripts/package-win-matrix.mjs", 'const runtimeFlavors = ["cpu", "cu130"];'],
